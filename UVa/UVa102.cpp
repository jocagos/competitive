...
int main(void){
  ...
  while( cin >> b[0] ){
    ...
    oMap<ll, string> v; // { 
    v.insert({ b[1] + b[2] + g[0] + g[1] + c[0] + c[2], "BCG" });// ,
    v.insert({ b[1] + b[2] + g[0] + g[2] + c[0] + c[1], "BGC" });//,
    v.insert({ c[1] + c[2] + b[0] + b[2] + g[0] + g[1], "CBG" });//,
    v.insert({ c[1] + c[2] + b[0] + b[1] + g[0] + g[2], "CGB" });//,
    v.insert({ g[1] + g[2] + b[0] + b[2] + c[0] + c[1], "GBC" });//,
    v.insert({ g[1] + g[2] + b[0] + b[1] + c[0] + c[2], "GCB" });// };
    auto p = *v.find_by_order( 0 );
